...
export const actions = {
  register:/** @param {import('./$types').RequestEvent} event */  async (event) => {
  ...
  login:/** @param {import('./$types').RequestEvent} event */  async (event) => {
  ...
  logout:/** @param {import('./$types').RequestEvent} event */  async (event) => {
